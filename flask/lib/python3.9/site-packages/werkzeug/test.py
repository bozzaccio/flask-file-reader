...
class Client:
    ...
    def run_wsgi_app(
        ...
        """Runs the wrapped WSGI src with the given environment.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param buffered: Convert the iterator returned by the src into
...
def run_wsgi_app(
    ...
    """
    # Copy environ to ensure any mutations by the src (ProxyFix, for
